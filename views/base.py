...
from mighty.functions import get_logger, tpl, tplx
...
class BaseView(PermissionRequiredMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        self._logger.info(f'view: {self.__class__.__name__}', extra={'user': self.request.user})
    ...
    def get_template_names(self):
        ...
        self._logger.debug(f'template: {self.template_name}', extra={'user': self.request.user, 'log_in_db': self.request.user})
