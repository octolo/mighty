...
{var obj=args.object,e=args.event,tooltip=args.tooltip,index=args.index,canvasXY=RGraph.getCanvasXY(obj.canvas),x=this.centerx;if(prop.align=='left'){x=x-this.radius-this.radius;}else if(prop.align=='right'){x=x+this.radius+this.radius;}
