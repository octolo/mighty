...
class AddressFormDesc(FormDescriptable):
    ...
    postal_code = forms.CharField(
        label=_.postal_code, max_length=255, required=False
    )
    state = forms.CharField(label=_.state, max_length=255, required=False)
    state_code = forms.CharField(
        label=_.state_code, max_length=255, required=False
    )
    ...
    cedex_code = forms.CharField(
        label=_.cedex_code, max_length=255, required=False
    )
    ...
    complement = forms.CharField(
        label=_.complement, max_length=255, required=False
    )
