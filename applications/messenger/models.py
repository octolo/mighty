...
class Missive(Base):
    ...
    user_or_invitation = models.ForeignKey(ContentType, on_delete=models.CASCADE, related_name="missive_userorinvitation", limit_choices_to=conf.limit_choices_to)
