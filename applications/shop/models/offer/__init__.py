...
class Offer(RealPrice, Image):
    ...
    frequency = models.CharField(
        max_length=255, choices=choices.FREQUENCIES, default=choices.MONTH
    )
    ...
    service = models.ManyToManyField(
        'mighty.ShopService', blank=True, related_name='service_offer'
    )
    service_tenant = models.ForeignKey(
        'mighty.ShopService', on_delete=models.SET_NULL, blank=True, null=True
    )
