        ...
        include([
            ...
            path(
                ...
                include([
                    ...
                    path(
                        'iban/',
                        views.IbanFormDescView.as_view(),
                        name='form-iban',
                    ),
                    path(
                        'paymentmethod/',
                        views.PaymentMethodFormDescView.as_view(),
                        name='pm-form',
                    ),
                    path(
                        'frequency/',
                        views.FrequencyFormDescView.as_view(),
                        name='pm-form',
                    ),
                ]),
            ),
    ...
    path(
        ...
        include([
            path(
                ...
                include([
                    path(
                        'checkstatus/<str:payment_id>/',
                        views.StripeCheckStatus.as_view(),
                        name='stripe-check-status',
                    ),
                ]),
            ),
        ]),
