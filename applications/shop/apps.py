...
class Config:
    ...
    invoice_backend = setting(
        'INVOICE_BACKEND',
        'mighty.applications.shop.backends.stripe.PaymentBackend',
    )
    ...
    class bank_card_conf:
        basic_cards = [
            ...
            {'cvc': '123', 'number': '5555555555554444', 'card': 'Mastercard'},
            {
                ...
                'card': 'Mastercard (série 2)',
            },
            {
                'cvc': '123',
                'number': '5200828282828210',
                'card': 'Mastercard (débit)',
            },
            {
                'cvc': '123',
                'number': '5105105105105100',
                'card': 'Mastercard (prépayée)',
            },
            {
                'cvc': '1234',
    ...
    class sepa_conf:
        basic_sepas = [
            ...
            {
                'iban': 'FR7920041010050500013M02600',
                'status': 'requires_payment_method3',
            },
...
if hasattr(settings, 'SHOP'):
    over_config(Config, settings.SHOP)
