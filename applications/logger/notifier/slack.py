...
from mighty.applications.logger.settings import SLACK_TOKEN, SLACK_CHANNEL
...
class SlackEventNotifier:
    ...
    def send_event(self, event_name, event_data, url=None, channel=None):
        ...
        try:
            response = self.client.chat_postMessage(channel=channel or self.channel, text=message)
