    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logfields', jsonfield.fields.JSONField(blank=True, default=dict, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objs', jsonfield.fields.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_or_invitation', models.ForeignKey(limit_choices_to={'app_label': 'mighty', 'model__in': ['user', 'userorinvitation']}, on_delete=django.db.models.deletion.CASCADE, related_name='missive_userorinvitation', to='contenttypes.contenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('translates', jsonfield.fields.JSONField(default=dict)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mighty.nationality')),
                ('translator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mighty.translator')),
            ],
            options={
                'abstract': False,
                'default_permissions': ('add', 'change', 'delete', 'view', 'anticipate', 'disable', 'enable', 'export', 'filterlvl0', 'filterlvl1', 'filterlvl2', 'import', 'list', 'source'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Email')),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None, unique=True, verbose_name='Phone')),
                ('status', models.CharField(choices=[('PENDING', 'pending'), ('REFUSED', 'refused'), ('ACCEPTED', 'accepted'), ('EXPIRED', 'expired')], default='PENDING', max_length=8)),
