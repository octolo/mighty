        ...
        class NewClass(obj):
            ...
            def registertask_view(
                ...
                return self.admincustom_view(
                    ...
                    object_id,
                    extra_context,
                    urlname=self.get_admin_urlname(
                        self.registertask_admin_suffix
                    ),
            ...
            def get_urls(self):
                ...
                my_urls = [
                    path(
                        ...
                        self.wrap(
                            self.registertask_view,
                            object_tools=self.registertask_object_tools,
                        ),
                        name=self.get_admin_urlname(
                            self.registertask_admin_suffix
                        ),
                    ),
                ]
