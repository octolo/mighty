...
def ImmutabledModel(**kwargs):
    def decorator(obj):
        ...
        obj.add_to_class('immutable', models.BooleanField(default=kwargs.get('immutable', False)))
        obj.add_to_class('immutable_delete', models.BooleanField(default=kwargs.get('delete', True)))
        obj.add_to_class('immutable_fields', models.TextField(
        ...
        def immutable_fields_editable(self):
            ...
            return base + tuple(field for field in self.immutable_fields.split(',') if hasattr(self, field))
        ...
        def can_be_deleted(self):
            if hasattr(obj, 'immutable_custom'): return self.immutable_custom
            return (not self.immutable or self.immutable_bypass or self.immutable_delete)
